                ...
                <div className="row g-lg-4">
                   <div className="col-lg-12 ps-lg-0">
                      <div className="show-date-details d-md-flex shadow mb-5 mb-lg-0">
                         ...
                         <a data-bs-toggle="modal" data-bs-target="#caldenderModal" className="my-4 btn ds-calender my-md-0"> <span> <img src={clicn} alt="cl"/>
                          </span> 25 February 2022 - 15  Mrach 2022 </a>
                      ...
                      <div className="comon-overview md-overview shadow mb-4 mb-lg-0">
                         <div className="d-flex w-100 justify-content-between align-items-center">
                               <div className="date-tx d-flex align-items-center">
                                  ...
                                  <h5 className="ms-2">
                                  15
                                  <span className="d-block"> Total Bookings </span>
                                  </h5>
                               </div>
                               <div className="list-count">
                                  <ul className="list-unstyled m-0">
                   ...
                   <div className="col-lg-12 ps-lg-0">
                      <div className="total-content-div new-dit-add p-3">
                               ...
                               <div className="new-review-div mt-4">
                                  <div class="tab-content mt-3" id="pills-tabContent">
                                        <div class="tab-pane fade " id="revenuneweday" role="tabpanel" aria-labelledby="pills-home-tab">
                                          ...
                                          <div className="new-edit-add position-relative">
                                                <div className="btn head-text-sp">
                                                   Rs. 15000/-
                                                </div>
                                                <div className="mt-5 flot-start w-100">
                                                   <NewRevinew/>
                                                </div>
                     ...
                     <div className="tab-content" id="pills-tabContent">
                        <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                              ...
                              <div className="patinent-details">
                                       ...
                                       <div className="cm-history row">
                                          <div className="col-lg-9">
                                             <div className="left-history">
                                                <h5 className="d-lg-flex"> Veena Rao 
                                                <span className="cm-link-a mx-2"> <FaMobileAlt/> +91 525236521 </span>
                                                <span className="cm-link-a "> <FaEnvelope/> +91 525236521 </span> </h5>
                                 ...
                                 <div className="ps-status-div speacial-accept col-lg-10 my-4">
