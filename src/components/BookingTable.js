...
class BookingTable extends React.Component {
  ...
  render() {
    return (
      ...
      <tr>
      <td colspan="7" id="div1" class="d-none targetDiv">
         <div class="tbl-re">
      ...
      <tr>
      <td colspan="7" id="div2" class="d-none targetDiv">
         <div class="tbl-re">
            <div class="td">Test Name</div>
            <div class="td">Mobile Number</div>
            <div class="td">Distance</div>
      ...
      <tr>
      <td colspan="7" id="div3" class="targetDiv d-none">
         <div class="tbl-re">
            <div class="td">Test Name</div>
            <div class="td">Mobile Number</div>
            <div class="td">Distance</div>
      ...
      <tr>
      <td colspan="7" id="div4" class="targetDiv d-none">
         <div class="tbl-re">
            <div class="td">Test Name</div>
            <div class="td">Mobile Number</div>
            <div class="td">Distance</div>
      ...
      <tr>
      <td colspan="7" id="div5" class="targetDiv d-none">
         <div class="tbl-re">
            <div class="td">Test Name</div>
            <div class="td">Mobile Number</div>
            <div class="td">Distance</div>
