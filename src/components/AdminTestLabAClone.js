...
class AdminTestLabAClone extends React.Component {
    componentWillMount(){
    ...
    render() {
      return (
          <>
            ...
            <a id="extra-fields-customer-add1" className="btn adbenf-btn mt-2 mb-4 mb-lg-0"> <img src={iconwebplush} alt="webn"/>  Add More </a>
          </>
      );
    }
  }
export default AdminTestLabAClone;