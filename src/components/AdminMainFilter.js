...
class AdminMainFilter extends React.Component {
    componentWillMount(){
      ...
      return(
          ...
          <div className="filter-wrapper">
                ...
                <ul id="filter-list" className="filter-list list-unstyled">
                    ...
                    <li className="filter-item">
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="flexCheckDefaultanc7"/>
                            <label className="form-check-label" for="flexCheckDefaultanc7">
                            Age
                            </label>
                        </div>
                    </li>
                    ...
                    <li className="filter-item">
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="flexCheckDefaultanc8"/>
                            <label className="form-check-label" for="flexCheckDefaultanc8">
                            Gender
                            </label>
                        </div>
                    </li>
                    ...
                    <li className="filter-item">
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="flexCheckDefaultanc9"/>
                            <label className="form-check-label" for="flexCheckDefaultanc9">
                            Satisfied
                            </label>
                        </div>
                    </li>
                    ...
                    <li className="filter-item">
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="flexCheckDefaultanc10"/>
                            <label className="form-check-label" for="flexCheckDefaultanc10">
                            City
                            </label>
                        </div>
                    </li>
