...
class LabBookingFilterA extends React.Component {
                    ...
                    <div className="filter-div-body">
                        <div className="d-flex justify-content-center">
                            <div className="col-lg-6 mt-5">
                                ...
                                <div id="tabs9" className="filter-form-div pt-2 pe-lg-4">
                                    <div className="comon-fild">
                                        <label> Status </label>
                                        <input type="text" className="form-control"/>
                                    </div>
                            ...
                            <div className="col-lg-6">
                                ...
                                <button type="button" className="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close">
                                    ...
                                    <div className="check-box-radio mt-4">
                                        ...
                                        <div className="form-check">
                                           <label className="form-check-label tab-b9" for="tabs-btn9">
                                            <input className="form-check-input cb-element" type="checkbox" value="" id="tabs-btn9"
                                            onChange={e=>changeHandal(e)}/>
...
export default LabBookingFilterA;
