...
class LabDashboradFilter extends React.Component {
                            ...
                            <div className="col-lg-6">
                                ...
                                <button type="button" className="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close">
                                    ...
                                    <div className="check-box-radio mt-4">
                                        ...
                                        <div className="form-check">
                                           <label className="form-check-label tab-b5" for="tabs-btn6">
                                        ...
                                        <div className="form-check">
                                           <label className="form-check-label tab-b5" for="tabs-btn7">
...
export default LabDashboradFilter;
