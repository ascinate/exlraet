                ...
                <form action="" method="post" role="form">
                   <div className="form-wizard-header">
					...
					<fieldset class="wizard-fieldset">
					   ...
					   <div className="inside-comon-div px-4 pb-5">
					        <input type="submit" className="btn submit-btn d-table mb-3 md-sm-0 me-auto ms-0 me-sm-0 ms-sm-auto" value="Submit"/>
							<h4>Booking Slot</h4>
							<hr/>  
							<div className="ad-fm mt-2">
							<a id="#" className="btn arrow-btn mb-4"> <span> <FaAngleLeft/> 
							...
							<div className="form-group mt-5 align-items-center d-lg-flex  clearfix">
							<a href="javascript:;" className="form-wizard-previous-btn float-left back-tn"> <FaAngleLeft/> Back</a>
