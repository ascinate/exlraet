...
import { FaRupeeSign, FaBell, FaBars,FaChevronLeft } from "react-icons/fa";
...
class LashboardCancelBooking extends React.Component {
    componentWillMount(){
      ...
      return(
          ...
          <div className='page-wrapper chiller-theme toggled'>
                ...
                <main className="body-total content-wrapper float-start w-100">
                    ...
                    <div id="book-admin-div" className="dasb-div d-none bk-div float-start w-100 pe-lg-3  payment-div">
                            ...
                            <div className="col-lg-12 ps-lg-0 mt-4">
                                <div className="tab-table pt-3 mb-5">
                                    <div className="d-lg-flex px-3 sp-button-adjucts justify-content-between align-items-start">
                    ...
                    <NavLink to="/adminlasboardbookingmain" className="btn mb-0 ps-0"> <FaChevronLeft/> Back</NavLink>
                    <div className="bk-inside-div">
                        <div className="col-lg-12 ps-lg-0">
                            ...
                            <div >
                                <div className="tab-table pt-3 mt-5 mb-5 new-table-cancel">
...
export default LashboardCancelBooking;