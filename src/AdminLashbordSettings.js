...
import AdminLashboardUserAdd from "./components/AdminLashboardUserAdd";
import SetingAddfild from "./components/SetingAddfild";



class AdminLashbordSettings extends React.Component {
    componentWillMount(){
                            ...
                            <div className="totals-tabs-sec mt-4">
                                ...
                                <div className="d-lg-flex align-items-start w-100">
                                    <div className="nav shadow flex-column nav-pills me-lg-3 col-lg-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <button className="nav-link" id="v-pills-new-edit-tab" data-bs-toggle="pill"
...
export default AdminLashbordSettings;