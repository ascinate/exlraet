...
import AdminTestInfomationModal from "./components/AdminTestInfomationModal";


class AdminTestNew extends React.Component {
    componentWillMount(){
                             ...
                             <div id="text-menu" >
                                <div className="show-date-details px-3 d-sm-flex shadow mb-5 mb-lg-0">
                                    <div className="d-flex align-items-center">
                                       ...
                                       <NavLink to="/adminpackages" className="btn pack-btn ms-3">
                                       Packages</NavLink>
                                    </div>
