...
class AdminLasboardBookingMain extends React.Component {
    componentWillMount(){
                    ...
                    <div id="book-admin-div" className="dasb-div bk-div float-start w-100 pe-lg-3  payment-div">
                            ...
                            <div className="show-date-details d-lg-flex shadow mb-5 mb-lg-0">
                                <div className="d-flex align-items-center">
                                   ...
                                   <NavLink to="/lashboardcancelbooking" id="canel-bookin-btn" className="btn booking-btn ms-3"> Cancelled Bookings </NavLink>
                                </div>
...
export default AdminLasboardBookingMain;