...
import LashboardBookingModal from "./components/LashboardBookingModal";
...
class LashboardBooking extends React.Component {
  componentWillMount(){
...
export default LashboardBooking;