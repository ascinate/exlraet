...
import AdminLashboardLabTable from "./components/AdminLashboardLabTable";
...
class AdminLashboardLab extends React.Component {
    componentWillMount(){
...
export default AdminLashboardLab;