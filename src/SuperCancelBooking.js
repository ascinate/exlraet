...
class SuperCancelBooking extends React.Component {
    componentWillMount(){
      ...
      return(
          ...
          <div className='page-wrapper chiller-theme toggled'>
                ...
                <main className="body-total content-wrapper float-start w-100">
                    ...
                    <NavLink to="/adminbookingmain" className="btn mb-0 ps-0"> <FaChevronLeft/> Back</NavLink>
...
export default SuperCancelBooking;