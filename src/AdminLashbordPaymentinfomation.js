...
import AdminPayemntInfomationFilter from "./components/AdminPayemntInfomationFilter";
import AdminInfomationTable from "./components/AdminInfomationTable";
import CalenderMultiple from "./components/CalenderMultiple";
import LashboardSidebar from "./LashboardSidebar";

class AdminLashbordPaymentinfomation extends React.Component {
    componentWillMount(){
                ...
                <main className="body-total content-wrapper float-start w-100">
                    ...
                    <div className="d-none d-lg-block">
                        <div className="top-bar-menu shadow float-start">
                            ...
                            <div class="d-flex align-items-center col-lg-9"><h5 class="mb-0 crm-newadd"> ABC Lab | <span>  
                            Lab4532666 </span>  </h5></div>
                            <TopMenu/>
                        </div>
                    </div>
                            ...
                            <div className="col-lg-12 ps-lg-0 mt-4">
                                <div className="tab-table pt-3 mb-5">
                                    ...
                                    <div className="table-sec-div ">
                                        <AdminInfomationTable/>
                                    </div>
                                </div>
                            </div>

                              <AdminPayemntInfomationFilter/>
...
export default AdminLashbordPaymentinfomation;