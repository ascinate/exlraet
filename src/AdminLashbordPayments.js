...
import AdminLashboradPaymentTable from "./components/AdminLashboradPaymentTable";

class AdminLashbordPayments extends React.Component {
    componentWillMount(){
...
export default AdminLashbordPayments;