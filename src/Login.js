                ...
                <div className="col-lg-5">
                    <div className="login-right">
                        ...
                        <div className="form-sec-login">
                            ...
                            <p className="register-btn text-center mt-3"> Admin Login? 
                                <NavLink to="/adminlogin"> Click Here </NavLink> 
                            </p>
                            <p className="register-btn text-center mt-3"> Admin Lashboard of lab Login? 
                                <NavLink to="/adminlashbord"> Click Here </NavLink> 
                            </p>
                            </form>
                        </div>
                    </div>
