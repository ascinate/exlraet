            ...
            <div className="main-menu d-none d-lg-block">
               <ul className="list-unstyled">
                 <li>
                   ...
                   <NavLink to="/userslotpage" activeClassName="menu_active"> <span className="menu-icon-new"> <img src={icon3} alt="icon1"/> </span> <span className="menu-text"> Available Slots </span> </NavLink>
                   <NavLink to="/newuserbooking" activeClassName="menu_active"> <span className="menu-icon-new"> <img src={bookingicon} alt="icon1"/> </span> <span className="menu-text"> Bookings </span> </NavLink>
                   ...
                   <NavLink to="/notifcationspage" activeClassName="menu_active"> <span className="menu-icon-new"> <img src={iconn} alt="icon1"/> </span> <span className="menu-text"> Notification </span>  </NavLink>
