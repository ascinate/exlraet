                            ...
                            <div className="totals-tabs-sec mt-4">
                                ...
                                <div className="d-lg-flex align-items-start w-100">
                                    <div className="nav shadow flex-column nav-pills me-lg-3 col-lg-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <button className="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#set-menu1" type="button"
                                        ...
                                        <button className="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                                        data-bs-target="#set-menu-edit" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                                        ...
                                        <div className="cm-se-menu">
                                            ...
                                            <span>
                                            <b className="d-block"> Edit Working Hours</b> 
                                    ...
                                    <div className="tab-content" id="v-pills-tabContent">
                                        <div className="tab-pane fade show active" id="set-menu1" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                            ...
                                            <div className="edit-tabs-div">
                                                ...
                                                <div className="edit-form col-lg-7">
                                                    ...
                                                    <div className="form-group pssword-fom">
                                                        ...
                                                        <input name="password" id="password-field" type="Password"  placeholder="**********" />
                                        ...
                                        <div className="tab-pane fade" id="set-menu-edit" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                            ...
                                            <div className="edit-tabs-div add-account-div-ts">
                                                ...
                                                <div className="edit-new-form col-lg-12">
                                                  ...
                                                  <input type="submit" className="btn mt-5 submit-btn" value="Submit"/>
                                        ...
                                        <div className="tab-pane fade d-none" id="set-menu3" role="tabpanel" aria-labelledby="v-pills-messages-tab">...</div>
                                        ...
                                        <div className="tab-pane fade" id="set-menu5" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                        ...
                                        <div className="tab-pane fade" id="set-menu6" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                            ...
                                            <div className="edit-tabs-div">
                                                    ...
                                                    <div className="row row-cols-1 row-cols-lg-3">
                                                        ...
                                                        <div className="col">
                                                            ...
                                                            <select class="form-select" aria-label="Default select example">
                                                                ...
                                                                <option value="1">Sachin Branch</option>
                                                                <option value="2">Rober William Branch</option>
                                                ...
                                                <input type="submit" className="btn d-table m-0 submit-btn" value="Save"/>
                                            </div>
