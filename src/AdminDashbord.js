            ...
            <div className="d-none d-lg-block">
             ...
             <div className="dasb-div bk-div float-start w-100">
                ...
                <div className="row g-lg-4">
                   ...
                   <div className="col-lg-6 col-xl-7 ps-lg-0">
                            ...
                            <div class="tab-content mt-3" id="pills-tabContent">
                              <div class="tab-pane fade " id="customerday" role="tabpanel" aria-labelledby="pills-home-tab">
                                 <div className="custome-div1">
                                    ...
                                    <figure className="new-graph ne-two-gf">
                                       <img src={Graphctwo} alt="gf"/>
                                    </figure>
                                 </div>
                               </div>
                   ...
                   <div className="col-lg-6 col-xl-5">
                      <div className="revenu-div p-3 mb-4 mb-lg-0">
                            ...
                            <div className="ts-performance new-size-1">
                               <figure className="new-graph">
                                  <img src={GraphcOne} alt="gf"/>
                               </figure>
                            </div>
                   ...
                   <div className="col-lg-12 ps-lg-0">
                      <div className="total-content-div  sp-admintable p-3 mb-5">
