...
import LabNotifcationFilter from "./components/LabNotifcationFilter";
import LabNotificationIssu from "./components/LabNotificationIssu";
import LabNotificationBooking from "./components/LabNotificationBooking";
import LabNotificationPayment from "./components/LabNotificationPayment";
import LabNoticFilterBooking from "./components/LabNoticFilterBooking";
import LabNoticFilterIusse from "./components/LabNoticFilterIusse";
import PaymentNoficationFilterN from "./components/PaymentNoficationFilterN";
import CalenderMultiple from "./components/CalenderMultiple";
import $ from "jquery";
import { NavLink } from "react-router-dom";


class NotifcationsPage extends React.Component {
    componentWillMount(){
    ...
    render() {
      return(
          ...
          <div className='page-wrapper chiller-theme toggled'>
                                    ...
                                    <div className="tab-table pt-3 mt-5 mb-5">
                                        <div className="d-md-flex px-3 justify-content-between align-items-start">
                                                <h2 className="cm-heading  mb-3 mb-md-0"> Payment Due
                                                    <span className="d-block sub-text"> 15 Results Found </span>
                                                    <a className="btn clean-btn cl-gray-cions"> 
                                                    <CalenderMultiple/> <img src={clgrayicon} alt="cl"/> </a>
                                                </h2>
            ...
            <LabNotifcationFilter/>

            <LabNoticFilterBooking/>
            <LabNoticFilterIusse/>
            <PaymentNoficationFilterN/>
          </>
      );
    }
  }
