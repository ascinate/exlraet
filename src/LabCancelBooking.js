...
import LabCancelBookingTable from "./components/LabCancelBookingTable";
import LabBookingCancelFilterMain from "./components/LabBookingCancelFilterMain";



class LabCancelBooking extends React.Component {
    componentWillMount(){
      ...
      return(
          ...
          <div className='page-wrapper chiller-theme toggled'>
                ...
                <main className="body-total content-wrapper float-start w-100">
                    ...
                    <div  className="dasb-div d-none bk-div sp-pack-page sp-div-top1 float-start w-100 pe-lg-3  payment-div">
                                ...
                                <div className="show-date-details px-3 d-sm-flex shadow mb-5 mb-lg-0">
                                    <div className="d-flex align-items-center">
                                       <h6 className="my-4 my-md-0 sp-h1 cm-heading-page"> <span> <img src={bookingicon} alt="cl"/> </span> Bookings </h6>
                                        <a id="canel-bookin-btn" className="btn booking-btn ms-3"> Cancelled Bookings </a>
                                    </div>
                                    <a className="btn graph-btn">
                                    <CalenderMultiple/> <img src={graphicon} alt="cl"/> Graphical View </a>
                    ...
                    <div  className="dasb-div technician-account-div sp-pack-page sp-div-top1 bk-div pe-lg-3 float-start w-100">
                    <NavLink to="/newuserbooking" className="btn mb-0 ps-0"> <FaChevronLeft/> Back</NavLink>
                    <div className="bk-inside-div">
                        <div className="col-lg-12 ps-lg-0">
                            ...
                            <div >
                                <div className="tab-table mt-4 mb-5">
                                    <div className="d-md-flex p-3 justify-content-between align-items-start">
                                            <div className="col-lg-6">    
                                                <h2 className="cm-heading col-lg-9 mb-3 mb-md-0"> Cancelled Bookings
                                                <a className="cld-icon ms-1 date-cancelpage1">
                                                <CalenderMultiple/>   <img src={clendericon} alt="icm"/>
                                                </a>
                                                
                                                </h2>
                                                <h6 className="d-block mt-0 sub-text mt-2"> 15 Results Found </h6>
                                            ...
                                            <div className="col-lg-6 d-flex justify-content-lg-end">
                                                    ...
                                                    <div className="dropdown">
                                                            ...
                                                            data-bs-toggle="offcanvas" href="#lab-booking-cancel-filter"  role="button" aria-controls="offcanvasExample">
...
export default LabCancelBooking;