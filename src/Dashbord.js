                ...
                <div className="row g-lg-4 ">
                   <div className="col-lg-12 mt-0 ps-lg-0">
                      <div className="show-date-details d-md-flex shadow mb-5 mb-lg-0">
                         ...
                         <a  className="my-4 btn ds-calender my-md-0"> <span> <img src={clicn} alt="cl"/>
                          </span> <CalenderMultiple/> 25 February 2022 - 15  March 2022 </a>
                   ...
                   <div className="col-md-4 ps-lg-0">
                      <div className="comon-overview pt-3 shadow mb-4 mb-lg-0">
                            ...
                            <div class="tab-content mt-3" id="pills-tabContent">
                               <div class="tab-pane fade " id="customerday" role="tabpanel" aria-labelledby="pills-home-tab">
                                 <div className="custome-div1">
                                   <figure className="ne-sp-grph mx-auto">
                                      <img src={Newgrphadd} alt="grph"/>
                                   </figure>
                                 </div>
                               </div>
